...
@interface LIViewController : UIViewController <SVLuaImplentatable>
...
@property(nonatomic, copy)NSString *_viewDidDismiss;
...
@property(nonatomic, copy)NSString *_canPerformAction;
