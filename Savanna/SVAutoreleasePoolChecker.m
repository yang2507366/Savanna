...
#import "SVAutoreleasePoolChecker.h"
...
@implementation SVAutoreleasePoolChecker
...
#ifdef DEBUGLOG
                        DEBUGLOG(@"skip do:%@", [script substringToIndex:minStackInfo.position]);
#endif
                    }else{
                        // push
