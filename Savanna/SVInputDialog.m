...
+ (void)showWithTitle:(NSString *)title
   ...
   approveButtonTitle:(NSString *)approveButtonTitle
           completion:(void(^)(NSString *input))completion
{
    [self showWithTitle:title message:message initText:initText clearButtonMode:UITextFieldViewModeWhileEditing cancelButtonTitle:cancelButtonTitle approveButtonTitle:approveButtonTitle completion:completion];
}
