...
@implementation SVHTTPDownloader
...
- (id)init
{
    ...
    self = [self initWithURLString:nil saveToPath:[[SVCommonUtils tmpPath] stringByAppendingPathComponent:tmpFilePath]];
    return self;
}
