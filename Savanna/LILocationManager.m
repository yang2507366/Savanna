...
@interface LILocationManagerDelegateProxy : NSObject <SVLocationManagerDelegate>
...
- (void)locationManager:(id)locationManager didUpdateToLocation:(CLLocation *)location
{
    if(self.liLocationMgr.didUpdateToLocation.length != 0){
        ...
        [[SVAppManager scriptInteractionWithAppId:self.liLocationMgr.appId]
...
- (void)locationManager:(id)locationManager didFailWithError:(NSError *)error
{
    if(self.liLocationMgr.didFailWithError.length != 0){
        [[SVAppManager scriptInteractionWithAppId:self.liLocationMgr.appId] callFunction:self.liLocationMgr.didFailWithError
...
@interface LILocationManager () <SVLocationManagerDelegate>
