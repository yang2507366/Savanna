...
@interface SVImagePicker () <UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverControllerDelegate>
...
@implementation SVImagePicker

+ (void)presentWithViewController:(UIViewController *)viewController completion:(ImagePickerCompletion)completion
{
    [[[SVImagePicker new] autorelease] presentWithViewController:viewController completion:completion];
}
...
- (void)presentWithViewController:(UIViewController *)viewController completion:(ImagePickerCompletion)completion
{
    ...
    if([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]){
        [SVAlertDialog showWithTitle:kTitleSelectPicture
                           message:nil
