...
{
    return [str sv_find:matching fromIndex:fromIndex reverse:reverse];
}

+ (NSString *)substring:(NSString *)str beginIndex:(NSInteger)beginIndex endIndex:(NSInteger)endIndex
{
    return [str sv_substringWithBeginIndex:beginIndex endIndex:endIndex];
}
...
{
    return [SVEncryptUtils stringByRemovingUnicode:string];
}

+ (NSString *)md5ForString:(NSString *)string
{
    return [SVEncryptUtils hexStringByMD5EncryptingString:string];
}
