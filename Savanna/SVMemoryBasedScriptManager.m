...
@interface SVMemoryBasedScriptManager ()
...
@implementation SVMemoryBasedScriptManager
...
- (id)initWithBaseScriptsDirectory:(NSString *)dir
{
    ...
    [SVFileUtils enumerateWithDirectoryPath:dir filePathBlock:^(NSString *filePath, BOOL isDirectory) {
        if(!isDirectory){
